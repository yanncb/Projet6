...
<%--        <form:input type="text" path="difficulte" class="form-control form-control-sm mb-3" placeholder="difficulte"></form:input>--%>
        ...
        <form:input type="text" path="altitude" class="form-control form-control-sm mb-3" placeholder="altitude"></form:input>

        <form:input type="text" path="type_roche" class="form-control form-control-sm mb-3" placeholder="type de roche"></form:input>
